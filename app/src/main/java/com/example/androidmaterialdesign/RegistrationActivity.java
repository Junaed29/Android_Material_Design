...
public class RegistrationActivity extends AppCompatActivity implements TextWatcher {
    ...
    // app:errorEnabled="true" create a gap which is helping app:counterEnabled="true"
    //  For this I comment fullNameEditText.setErrorEnabled(false);
    ...
    private Boolean validPassword(String val) {
        ...
        if (val.isEmpty()) {
            ...
            passwordEditText.setError("Must have at least 1 digit");
            return false;
        }
